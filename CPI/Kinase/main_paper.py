...
if __name__ == "__main__":
    ...
    """Output files."""
    file_AUCs = 'output/result/AUCs--lr=1e-4,dropout=0.2,weight_decay=1e-4,kernel=9,n_layer=3,batch=8,balance,lookaheadradam'+ '.txt'
    file_model = 'output/model/' + 'lr=1e-4,dropout=0.2,weight_decay=1e-4,kernel=9,n_layer=3,batch=8,balance,lookaheadradam'
